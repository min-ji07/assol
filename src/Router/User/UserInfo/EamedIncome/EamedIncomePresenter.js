                ...
                <div id="userInfoLeft" class="test">
                    ...
                    <div class="right_div_inner">
                        <ul class="userinfo_right_box">
                            ...
                            <li>전화번호 :<input type="text" maxLength="13" class="tell_input" name="tellNo" id="tellNo" placeholder="02-000-0000" /></li>
                            <li>휴대폰 :<input type="text" maxLength="13" class="phone_input" name="mobile" id="mobile" placeholder="010-0000-0000" /></li>
                            <li>
                                <span>이메일 :</span>
