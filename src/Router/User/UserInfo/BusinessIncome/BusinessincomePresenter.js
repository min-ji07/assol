...
const BusinessincomePresenter = ({rowData, euduDefs, carrerDefs, dependDefs, militaryDefs, curriculumDefs, rowData2, rowData3, rowData4, rowData5}) => {
    ...
    return (
    <div className="div_bottom tab_02">
        <form> 
            <div className="left_div">
                <div id="userInfoLeft2" className="test">
                    <div className="left_div_inner">
                    <div className="imgload">
                        <img id="userImgView2" className="userImgView" src='/images/user02.png' alt="유저사진"/>
                        <span id="userImgText2" className="userImgText" style={{display:"block"}}>사원 사진을 등록해주세요.</span>
                        <div style={{marginTop:"5px"}}>
                            <label for="userImage2" className="userImg">수정</label><input type="file" id="userImage2" className="userImageInput" name="userImageInput" accept="image/*"/>
                    ...
                    <div className="right_div_inner">
                        <ul className="userinfo_right_box">
                            <li>
                                <span>전화번호 :</span>
                                <input type="text" className="tell_input" name="tellNo" id="tellNo" placeholder="02-000-0000"  />
                            </li>
                            <li>
                                <span>휴대폰 :</span>
                                <input type="text" maxLenght="13" className="phone_input" name="mobile" id="mobile" placeholder="010-0000-0000"  />
                            </li>
                            <li>
                                <span>이메일 :</span>
            ...
            <div className="right_div tab_02">
                ...
                <div className="div_bottom right">
                    <div className="sal_inner">
                        {/* 급여상세 */}
                        <div id="userInfoRight2" className="input_content tab_004">
                            <ul>
                                <li style={{listStyle:"disc", height:"21px", lineHeight:"21px"}}>
                                    <strong>급여항목</strong>
                                </li>
                                <li className="salary" style={{marginTop:"10px", height:"100px", listStyle:"none"}}>
                                    <ul>
                                        <li>총 연간 소득금액 :
                                            <input type="text" className="money_input" name="totalPayOfYear" id="totalPayOfYear" placeholder="10,000,000" /> 원
                                        </li>
                                        <li style={{listStyle:"none", float:"left", display:"inline-block", marginLeft:"48px"}}>
                                            ...
                                            <input type="text" className="money_input" name="payQuarter" id="payQuarter" placeholder="10,000,000" /> 원
                                        </li>
                                        <li style={{width:"325px", marginLeft:"280px"}}>기타부대수당 : 
                                            ...
                                            <input type="text" className="money_input" name="otherExtraPay" id="otherExtraPay" placeholder="10,000,000" />원
                                        </li>
                                    </ul>
                                </li>
                                ...
                                <li className="ul_li_left" style={{height:"132px", borderBottom:"1px solid #dedede"}}>
                                    <strong>사업자등록번호</strong>
                                    <span style={{color:"#f38d8d", fontSize:"13px"}}> *소유자일 경우</span>
                                    <ul>
                                        <li style={{listStyle:"none", marginLeft:"0px"}}>
                                            사업자등록번호 : <input className="num_input" type="text" maxLength="3" id="businessNo1" placeholder="00"  style={{width:"40px", border:"none", borderBottom:"1px solid #8a8a8a"}}/>-
                                            <input className="num_input" type="text" maxLength="2" id="businessNo2" placeholder="00"  style={{width:"40px", border:"none", borderBottom:"1px solid #8a8a8a"}}/>-
                                            <input className="num_input" type="text" maxLength="5" id="businessNo3" placeholder="000" style={{width:"70px", border:"none", borderBottom:"1px solid #8a8a8a"}}/>
                                        </li>
                                    </ul>
                                </li>
                            </ul>
                        ...
                        {/* 학력교육 */}
                        <div className="input_content tab_005">
                            <ul>
                                <li>학력
                                ...
                                <li style={{marginTop:"20px"}}>경력
                                    <div className="tab_02_inner">
                                        ...
                                        <div className="tab_02_grid grid_scrollX_none carrerGrid">
