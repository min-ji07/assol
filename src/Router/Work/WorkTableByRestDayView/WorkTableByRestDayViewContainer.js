    ...
    const gridSetting =()=>{
        //컬럼 정의
           const columnDefs= [  
               ...
               ,{ headerName: "성명", field: "userName"}
               ,{ headerName: "직책", field: "position"}
               ,{ headerName: "직위", field: "levelPosition"}
               ,{ headerName: "입사일자", field: "joinDate"}

               ,{ headerName: "퇴사일자", field: "leaveDate"}

               ,{ headerName: "발생연차", field: "accumulatedAnnual", width:80} 
               ,{ headerName: "사용연차", field: "allUseAnnual", width:80,
                    cellRenderer:function(params){
                        return `<span class='txt_red02'>${params.value}</span>`
                    }
                }
               ,{ headerName: "잔여연차", field: "remainAnnual", width:80,
                    cellRenderer:function(params){
                        return `<span class='txt_blue01'>${params.value}</span>`
                    }
                }
               ,{ headerName: "정산연차", field: "payBackAnnualCount", width:80}
               ,{ headerName: "이월연차", field: "payBackAnnualCount", width:80}

               ,{ headerName: "1월", field: "days", width:45,
                    valueGetter: function(params) {
                        return params.data.days[0];
                    },
                }
               ,{ headerName: "2월", field: "days", width:45,
                    valueGetter: function(params) {
                        return params.data.days[1];
                    },
                }
               ,{ headerName: "3월", field: "days", width:45,
                    valueGetter: function(params) {
                        return params.data.days[2];
                    },
                }
               ,{ headerName: "4월", field: "days", width:45,
                    valueGetter: function(params) {
                        return params.data.days[3];
                    },
                }
               ,{ headerName: "5월", field: "days", width:45,
                    valueGetter: function(params) {
                        return params.data.days[4];
                    },
                }
               ,{ headerName: "6월", field: "days", width:45,
                    valueGetter: function(params) {
                        return params.data.days[5];
                    },
                }
               ,{ headerName: "7월", field: "days", width:45,
                    valueGetter: function(params) {
                        return params.data.days[6];
                    },
                }
               ,{ headerName: "8월", field: "days", width:45,
                    valueGetter: function(params) {
                        return params.data.days[7];
                    },
                }
               ,{ headerName: "9월", field: "days", width:45,
                    valueGetter: function(params) {
                        return params.data.days[8];
                    },
                }
               ,{ headerName: "10월", field: "days", width:50,
                    valueGetter: function(params) {
                        return params.data.days[9];
                    },
                }
               ,{ headerName: "11월", field: "days", width:50,
                    valueGetter: function(params) {
                        return params.data.days[10];
                    },
                }
               ,{ headerName: "12월", field: "days", width:50,
                    valueGetter: function(params) {
